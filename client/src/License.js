    ...
    return  (
      <div>
        ...
        <div>
          ...
          los datos proveídos por la SET no tienen licencia y pueden encontrarse <a target="_blank" 
          href="http://www.set.gov.py/portal/PARAGUAY-SET/InformesPeriodicos?folder-id=repository:collaboration:/sites/PARAGUAY-SET/categories/SET/Informes%20Periodicos/listado-de-ruc-con-sus-equivalencias">
          aquí</a>
          </p>
        </div>
      </div>
